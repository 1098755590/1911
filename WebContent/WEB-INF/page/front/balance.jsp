...
<section class="cartMain">
   ...
   <form action="buyagood" method="post">
	...
	<div class="bar-wrapper">
		<div class="bar-right">
			...
			<div class="calBtn" style="background-color:#FF4400; margin:0px;padding:0px;"><a style="background-color:#FF4400; margin:0px;padding:0px;"><button style="background-color:#FF4400; margin:0px;padding:0px;cursor:pointer;">确认购买</button></a></div>
		</div>
	</div>
	 </form>
</section>
...
$.ajax({
	    ...
	    success : function(e) {
	    	var data=e.data;
			   console.log(data);
			   $("#goods_id0").val(goods_id);
			   $("#art0").append('<ul class="order_lists"><li class="list_chk"><input  type="checkbox" id="checkbox_2" class="son_check"><label for="checkbox_2"></label></li><li class="list_con"><div class="list_img"><a href="javascript:;"><img src="./file/'+data[0].goods_picture+'" alt=""></a></div><div class="list_text"><a href="javascript:;">'+data[0].goodsname+'</a></div></li><li class="list_info"><p>规格：默认</p><p>'+data[0].goods_detail+'</p></li><li class="list_price"><p class="price">￥'+data[0].goods_price+'</p></li><li class="list_amount"><div class="amount_box"><a href="javascript:;" class="reduce reSty">-</a><input type="text" name="count" value="1" class="sum"><a href="javascript:;" class="plus">+</a></div></li><li class="list_sum"><p class="sum_price">￥'+data[0].goods_price+'</p></li><li class="list_op"><p class="del"><a href="javascript:;" class="delBtn">移除商品</a></p></li></ul>');
